        ...
        <div class="row align-items-center">
            <div class="col-xxl-5 col-xl-6 col-lg-6 wow fadeInLeft">
                <div class="wsus__sign_img">
                    <img src="<?php echo e(asset('frontend/assets/images/login_img_2.jpg')); ?>" alt="login" class="img-fluid">
                    <a href="index.html">
                ...
                <div class="wsus__sign_form_area">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form action="<?php echo e(route('register', ['type' => 'student'])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <h2>Sign Up<span>!</span></h2>
                                <p class="new_user">Already have an account? <a href="<?php echo e(route('login')); ?>">Sign In</a></p>
                                <div class="row">

                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            <label>Name</label>
                                            <input type="text" placeholder="First name" name="name" value="<?php echo e(old('name')); ?>" required>
...
<?php endif; ?>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            ...
                                            <input type="email" placeholder="Your email" name="email" value="<?php echo e(old('email')); ?>" required>
...
<?php endif; ?>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                            ...
                            <form action="<?php echo e(route('register', ['type' => 'instructor'])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/auth/register.blade.php ENDPATH**/ ?>