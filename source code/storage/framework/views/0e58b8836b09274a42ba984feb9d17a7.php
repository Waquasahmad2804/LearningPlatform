    ...
    <div class="tab-pane fade show active" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
        ...
        <div class="add_course_content">
            <div class="add_course_content_btn_area d-flex flex-wrap justify-content-between mt-3">
                <a class="common_btn dynamic-modal-btn btn btn-primary" href="#" data-id="<?php echo e($courseId); ?>"> Add New Chapter</a>
                <a class="common_btn sort_chapter_btn btn btn-primary" data-id="<?php echo e($courseId); ?>" href="javascript:;">Short Chapter</a>
            </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <div class="add_course_content_action_btn">
                                ...
                                <a class="edit edit_chapter" data-course-id="<?php echo e($chapter->course_id); ?>" data-chapter-id="<?php echo e($chapter->id); ?>" href="#"><i class="ti ti-edit"></i></a>
                                <a class="del delete-item" href="<?php echo e(route('admin.course-content.destory-chapter', $chapter->id)); ?>"><i class="ti ti-trash-x"></i></a>
                            </div>
                        </h2>
                                    ...
                                    <li class="" data-lesson-id="<?php echo e($lesson->id); ?>" data-chapter-id="<?php echo e($chapter->id); ?>">
                                        ...
                                        <div class="add_course_content_action_btn">
                                            <a class="edit_lesson" data-lesson-id="<?php echo e($lesson->id); ?>" data-chapter-id="<?php echo e($chapter->id); ?>"
                                                data-course-id="<?php echo e($chapter->course_id); ?>" class="edit" href="javascript:;"><i class="ti ti-edit"></i></a>
                                            <a class="del delete-item" href="<?php echo e(route('admin.course-content.destroy-lesson', $lesson->id)); ?>"><i class="ti ti-trash-x"></i></a>
...
<?php echo $__env->make('admin.course.course-module.course-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/admin/course/course-module/course-content.blade.php ENDPATH**/ ?>