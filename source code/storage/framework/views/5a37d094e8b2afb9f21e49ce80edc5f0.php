...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wsus__contact_us mt_95 xs_mt_75 pb_120 xs_pb_100">
        <div class="container">
            <div class="row">
                <?php $__currentLoopData = $contactCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contactCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-3 col-md-6 col-lg-4 wow fadeInUp">
                    <div class="wsus__contact_info">
                        <div class="icon">
                            <img src="<?php echo e($contactCard->icon); ?>" alt="contact" class="img-fluid">
                        </div>
                        <h4><?php echo e($contactCard->title); ?></h4>
                        <p><?php echo e($contactCard->line_one); ?></p>
                        <p><?php echo e($contactCard->line_two); ?></p>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-5 d-md-none d-lg-block">
                        <div class="wsus__contact_form_img">
                            <img src="<?php echo e(asset($contactSetting?->image)); ?>" alt="contact" class="img-fluid">
                        </div>
                    </div>
...
<?php endif; ?>
        ...
        <?php if($contactSetting?->map_url): ?>
        <div class="wsus__contact_map mt_120 xs_mt_100 wow fadeInUp">
            <iframe
                src="<?php echo e($contactSetting->map_url); ?>"
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>