    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.course-categories.update', $course_category->id)); ?>" method="POST"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image-preview','data' => ['src' => ''.e(asset($course_category->image)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['src' => ''.e(asset($course_category->image)).'']); ?>
...
<?php $component = App\View\Components\InputBlock::resolve(['name' => 'name','value' => $course_category->name,'placeholder' => 'Enter category name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\InputToggleBlock::resolve(['name' => 'show_at_treading','label' => 'Show at Trading','checked' => $course_category->show_at_trending == 1] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <?php if (isset($component)) { $__componentOriginal02c8be0a552df5d5c2ef27fd4f1bfe95 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal02c8be0a552df5d5c2ef27fd4f1bfe95 = $attributes; } ?>
<?php $component = App\View\Components\InputToggleBlock::resolve(['name' => 'status','checked' => $course_category->status == 1,'label' => 'Status'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-toggle-block'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/admin/course/course-category/edit.blade.php ENDPATH**/ ?>