...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/admin.css', 'resources/js/admin/admin.js']); ?>
    <?php echo $__env->yieldPushContent('header_scripts'); ?>
</head>

<body>
    <script src="<?php echo e(asset('admin/assets/dist/js/demo-theme.min.js?1692870487')); ?>"></script>
    <div class="page">
        <!-- Sidebar -->
    ...
    <script src="<?php echo e(asset('frontend/assets/js/jquery-ui.min.js')); ?>" defer></script>
...
<?php /**PATH C:\Users\pc\Desktop\FinalYearProject\source code\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>