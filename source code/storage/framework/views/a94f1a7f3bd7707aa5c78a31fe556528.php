...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/animated_barfiller.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/scroll_button.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/nice-select.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/pointer.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/jquery.calendar.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/range_slider.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/startRating.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/video_player.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/jquery.simple-bar-graph.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/select2.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/sticky_menu.css')); ?>">
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/frontend/player.js']); ?>
</head>
...
<body class="home_3">
    ...
    <section class="wsus__course_video">
        <div class="col-12">
            <div class="wsus__course_header">
                <a href="<?php echo e(route('student.dashboard')); ?>"><i class="fas fa-angle-left"></i> Go Back</a>
                <p>Your Progress: <?php echo e($lessonCount); ?> of <?php echo e(count($watchedLessonIds)); ?> (<?php echo e(round((count($watchedLessonIds) / $lessonCount) * 100)); ?>%)</p>
            </div>
        </div>
                        ...
                        <div id="collapse-<?php echo e($chapter->id); ?>" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <?php $__currentLoopData = $chapter->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check" >
                                        <input <?php if(in_array($lesson->id, $watchedLessonIds)): echo 'checked'; endif; ?> class="form-check-input make_completed" data-course-id="<?php echo e($course->id); ?>" data-lesson-id="<?php echo e($lesson->id); ?>" data-chapter-id="<?php echo e($chapter->id); ?>" name="" type="checkbox" value="">
                                        <label class="form-check-label lesson" data-course-id="<?php echo e($course->id); ?>"
                                        data-lesson-id="<?php echo e($lesson->id); ?>" data-chapter-id="<?php echo e($chapter->id); ?>">
                                            <?php echo e($lesson->title); ?>

                                            <span>
                                                <img src="<?php echo e(asset('frontend/assets/images/video_icon_black_2.png')); ?>"
                                                    alt="video" class="img-fluid">
                                                <?php echo e(convertMinutesToHours($lesson->duration)); ?>
    ...
    <!--font-awesome js-->
    <script src="<?php echo e(asset('frontend/assets/js/Font-Awesome.js')); ?>"></script>
    <!--marquee js-->
    ...
    <script src="<?php echo e(asset('frontend/assets/js/jquery.countup.min.js')); ?>"></script>
    <!--venobox js-->
    ...
    <!--Scroll Button js-->
    <script src="<?php echo e(asset('frontend/assets/js/scroll_button.js')); ?>"></script>
    <!--pointer js-->
    <script src="<?php echo e(asset('frontend/assets/js/pointer.js')); ?>"></script>
    <!--range slider js-->
    <script src="<?php echo e(asset('frontend/assets/js/range_slider.js')); ?>"></script>
    <!--barfiller js-->
    <script src="<?php echo e(asset('frontend/assets/js/animated_barfiller.js')); ?>"></script>
    <!--calendar js-->
    <script src="<?php echo e(asset('frontend/assets/js/jquery.calendar.js')); ?>"></script>
    <!--starRating js-->
    <script src="<?php echo e(asset('frontend/assets/js/starRating.js')); ?>"></script>
    <!--Bar Graph js-->
    <script src="<?php echo e(asset('frontend/assets/js/jquery.simple-bar-graph.min.js')); ?>"></script>
    <!--select2 js-->
    <script src="<?php echo e(asset('frontend/assets/js/select2.min.js')); ?>"></script>
    <!--Video player js-->
    <script src="<?php echo e(asset('frontend/assets/js/video_player.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/video_player_youtube.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/videojs-vimeo.umd.js')); ?>"></script>
    <script src="https://unpkg.com/jszip/dist/jszip.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets/js/docx-preview.min.js')); ?>"></script>
    <!--wow js-->
    ...
    <script>
        $(function() {
            ...
            $.each(lessons, function(index, lesson) {
                ...
                if (
                    chapterId == <?php echo e($lastWatchHistory?->chapter_id); ?> &&
                    courseId == <?php echo e($lastWatchHistory?->course_id); ?> &&
                    lessonId == <?php echo e($lastWatchHistory?->lesson_id); ?>
...
<?php /**PATH C:\laragon\www\edu-core\resources\views/frontend/student-dashboard/enrolled-course/player-index.blade.php ENDPATH**/ ?>