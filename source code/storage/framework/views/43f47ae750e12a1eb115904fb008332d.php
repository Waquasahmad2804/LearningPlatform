<div class="mb-3">
    <label class="form-label text-capitalize"><?php echo e($label ? $label : str_replace('_', ' ', $name)); ?></label>
...
<?php endif; ?>
    <?php if(isset($hint)): ?>
       <?php echo e($hint); ?> 
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\edu-core\resources\views/components/input-block.blade.php ENDPATH**/ ?>