                                                        ...
                                                        <td class="action">
                                                            <a class="edit"
                                                                href="{{ route('instructor.courses.edit', ['id' => $course->id, 'step' => 1]) }}"><i
                                                                    ...
                                                                    <form action="{{ route('instructor.courses.delete', ['id' => $course->id]) }}" method="POST" style="display:inline;">
    @csrf
    <button type="submit" 
    style="padding: 3px 5px; border-radius:20% "
    class="del" onclick="return confirm('Are you sure you want to delete this course?')">
