...
<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
    <div class="add_course_basic_info">
        <form action="<?php echo e(route('instructor.courses.sore-basic-info')); ?>" method="post" class="basic_info_update_form course-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.course.course-module.course-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/admin/course/course-module/edit.blade.php ENDPATH**/ ?>