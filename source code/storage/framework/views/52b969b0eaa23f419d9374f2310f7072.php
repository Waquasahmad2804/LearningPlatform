    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(auth('admin')->check() ? route('admin.unisharp.lfm.upload') : route('unisharp.lfm.upload')); ?>" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
...
<?php /**PATH C:\laragon\www\edu-core\resources\views/vendor/laravel-filemanager/index.blade.php ENDPATH**/ ?>