            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <?php if(user()->role != 'instructor'): ?>
                        <div class="text-end">
                            <a href="<?php echo e(route('student.become-instructor')); ?>" class="btn btn-primary">Become a
                                Instructor</a>
                        </div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="col-xl-4 col-sm-6 wow fadeInUp">
                            <div class="wsus__dash_earning">
                                ...
                                <h3><?php echo e($pendingCourses); ?></h3>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6 wow fadeInUp">
                            <div class="wsus__dash_earning">
                                <h6>Approved Courses</h6>
                                <h3><?php echo e($approvedCourses); ?></h3>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6 wow fadeInUp">
                            <div class="wsus__dash_earning">
                                <h6>Rejected Courses</h6>
                                <h3><?php echo e($rejectedCourses); ?></h3>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\FinalYearProject\source code\resources\views/frontend/instructor-dashboard/index.blade.php ENDPATH**/ ?>