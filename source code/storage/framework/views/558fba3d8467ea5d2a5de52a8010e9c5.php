        ...
        <div class="row">
                ...
                <div class="payment_area">
                    <div class="row">
                        <div class="col-xl-3 col-6 col-md-4 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <a href="<?php echo e(route('paypal.payment')); ?>" class="payment_mathod">
                                <img style="max-width: 100% !important;" src="<?php echo e(asset('default-files/paypal-logo.png')); ?>" alt="payment" class="img-fluid w-100">
                            </a>
                        </div>
                        <div class="col-xl-3 col-6 col-md-4 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <a href="<?php echo e(route('stripe.payment')); ?>" class="payment_mathod">
                                <img src="<?php echo e(asset('default-files/stripe-logo.png')); ?>" alt="payment" class="img-fluid w-100">
                            </a>
                        </div>
                        <div class="col-xl-3 col-6 col-md-4 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <a href="<?php echo e(route('razorpay.redirect')); ?>" class="payment_mathod">
                                <img src="<?php echo e(asset('default-files/razorpay-logo.png')); ?>" alt="payment" class="img-fluid w-100">
                            </a>
                        </div>
            ...
            <div class="col-xl-4 col-lg-5 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div class="total_payment_price">
                    <h4>Total Cart <span>(0<?php echo e(cartCount()); ?>)</span></h4>
                    <ul>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/frontend/pages/checkout-page.blade.php ENDPATH**/ ?>