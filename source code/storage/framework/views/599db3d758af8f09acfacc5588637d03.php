            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="<?php echo e(route('admin.social-links.index')); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.social-links.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
<?php $component = App\View\Components\InputFileBlock::resolve(['name' => 'icon'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\edu-core\resources\views/admin/social-link/create.blade.php ENDPATH**/ ?>